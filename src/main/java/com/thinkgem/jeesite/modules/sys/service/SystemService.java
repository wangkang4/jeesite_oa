...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	//更新总天数
	@Transactional(readOnly=false)
	public void updateNumOverTimeById(User user){
		userDao.updateNumOverTimeById(user);
	}
	//查询总天数
	@Transactional(readOnly=true)
	public double selectNumOverTimeById(User user){
		double num=userDao.selectNumOverTimeById(user);
		return num;
	}
	//更新可用天数
	@Transactional(readOnly=false)
	public void updateUseOverTimeById(User user){
		userDao.updateUseOverTimeById(user);
		
	}
	//查询可用天数
	@Transactional(readOnly=true)
	public double selectUseOverTimeById(User user){
		double use=userDao.selectUseOverTimeById(user);
		return use;
	}
	//查询总的请假天数
	@Transactional(readOnly=true)
	public double selectNumLeaveDays(User user){
		double num=userDao.selectNumLeaveDays(user);
		return num;
	}
	
	//更新总的请假天数
	@Transactional(readOnly=false)
	public void updateNumLeaveDays(User user){
		userDao.updateNumLeaveDays(user);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<User> getWechatUserInformation() {
		...
		return userDao.getWechatUserInformation();
	}
	//更新微信平台用户的用户id
	@Transactional(readOnly = false)
	public void saveWechatId(String id, String userid) {
		
		userDao.saveWechatId(id,userid);
	}
