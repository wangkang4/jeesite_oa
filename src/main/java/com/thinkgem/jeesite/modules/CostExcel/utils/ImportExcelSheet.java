...
public class ImportExcelSheet {
     ...
     * 存放多个sheet的数据
     */
    private Map<String, List<List<String>>> map = new HashMap<String, List<List<String>>> ();
    ...
    public void read(InputStream inputStream, boolean isExcel2003) {
        try {
            /** 根据版本选择创建Workbook的方式 */
            Workbook wb = null;
            if (isExcel2003) {
    ...
    private void read(Workbook wb) {
        ...
        /** shell总数 */
        this.totalSheets = wb.getNumberOfSheets ();
