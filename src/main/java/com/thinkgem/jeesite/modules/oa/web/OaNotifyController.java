...
public class OaNotifyController extends BaseController {
    ...
    public String save(OaNotify oaNotify, Model model, RedirectAttributes redirectAttributes, OaNotifyRecord oaNotifyRecord) {
        ...
        System.out.println ( "----content-----" + oaNotify.getFiles () );
    ...
    public String view(OaNotify oaNotify, Model model) {
        if (StringUtils.isNotBlank ( oaNotify.getId () )) {
            ...
            List<FileModel> filelist = oaNotifyService.findfiles ( oaNotify.getId () );
            model.addAttribute ( "filelist", filelist );
            return "modules/oa/selfOaNotify";
        }
