...
<body>
	...
	<form id ="form" action="${ctx }/customer/saveexamine"  method="post" class="form-horizontal">
		...
		<div  class="control-group" >
			...
			<div class="controls" >
			<textarea name="reject" rows="6" style="width: 900px"></textarea>
			<input name="examine" id="examine" type="hidden" value=""/>
			<input name="id" id="id" type="hidden" value="${customerInfo.id }"/>
			</div>
