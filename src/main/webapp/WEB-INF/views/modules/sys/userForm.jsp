...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="leader" name="leader"
								value="${user.leader}" labelName="user.leader" labelValue="${user.leaderName}"
								title="上级领导" url="/sys/office/treeData?type=3"
		...
		<div class="control-group">
			<label class="control-label">是否是该部门领导:</label>
			<div class="controls">
				<form:select path="leaderid" class="input-xlarge">
