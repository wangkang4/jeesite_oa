...
<ul class="nav nav-tabs">
    <li class=""><a href="${ctx}/tb/purchase/list">采购申请列表</a></li>
    ...
    <shiro:hasAnyRoles name="xingzheng">
        <li class="active"><a href="${ctx}/tb/purchase/list2">所属区域员工采购列表</a></li>
    </shiro:hasAnyRoles>
    <shiro:hasAnyRoles name="caiwu">
        <li class=""><a href="${ctx}/tb/purchase/list4">查看员工申请列表</a></li>
    </shiro:hasAnyRoles>
</ul>
