...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="">回款计划修改</a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="pmsPayment" action="${ctx}/oapms/pmsPayment/updatePms" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
			 <input type="text" class="" name="paymentAmount" value="${pmsPayment.paymentAmount }">
				<span class="help-inline"><font color="red" id="paymentTimeWarn">*</font> </span>
		 </div>
	</div>
		...
		<div class="control-group">
			...
			<form:select path="paymentMode" class="input-medium">
					...
					<form:options items="${fns:getDictList('pms_payment_mode')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red" id="paymentModeWarn"></font> </span>
		</div>
	</div>
	...
	<div class="control-group">
			...
			<form:select path="paymentStatus" class="input-medium">
					<form:option value="" label="请选择"/>
					<form:options items="${fns:getDictList('pms_payment_status')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red" id="paymentStatusWarn"></font> </span>
		</div>
	</div>
