...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="">修改合同</a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="pmsContract" action="${ctx}/oapms/pmsContract/updatePms" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<div class="control-group">
			<label class="control-label">合同标题:</label>
			<div class="controls">
                <input type="text" class="" name="title" value="${pmsContract.title }">
		...
		<div class="control-group">
			...
			<div class="controls">
			<select class="input-medium" id="customerId" name="customerId">
					<option value="">请选择</option>
					<c:forEach items="${customerList }" var="customer">
						<option value=${customer.customerId } <c:if test="${pmsContract.customer.customerName == customer.customerName}">  selected  </c:if>>${customer.customerName }</option>
					</c:forEach>
				</select>
		...
		<div class="control-group">
			...
			<select class="input-medium" name="projectId" id="projectId">
					<option value="">请选择</option>
					<c:forEach items="${pmsProjectList }" var="project">
						<option value=${project.projectId }  <c:if test="${pmsContract.pmsProject.projectName == project.projectName}">  selected </c:if>>
						${project.projectName }</option>
					</c:forEach>
				</select>
				<span class="help-inline"><font color="red" id="projectIdWarn">*</font> </span>
		</div>
	</div>
		...
		<div class="control-group">
			...
			<div class="controls">
                <input type="text" class="" id="amount" name="amount" value="${pmsContract.amount }">
				<span class="help-inline"><font color="red" id="amountWarn">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
                <input type="text" class="" name="totalAmount" value="${pmsContract.totalAmount }">
				<span class="help-inline"><font color="red" id="totalAmountWarn">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline"><font color="red" id="startTimeWarn">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
				<span class="help-inline"><font color="red" id="endTimeWarn">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
                <input type="text" class="" name="servicePeriod" value="${pmsContract.servicePeriod }">
				<span class="help-inline"><font color="red" id="servicePeriodWarn">*</font> </span>
			</div>
		</div>
       ...
       <%-- <form:textarea path="contractTerms" rows="5" maxlength="2000" cssStyle="width:500px" />  --%> 
                <input type="text" class="" name="contractTerms" value="${pmsContract.contractTerms }">
		...
		<div class="form-actions">
			<input id="btnSubmit" class="btn btn-primary" type="button" onclick="return submitForm()" value="保 存"/>&nbsp;
