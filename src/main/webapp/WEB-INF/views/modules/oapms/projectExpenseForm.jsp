...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/pms/projectHelp/expenseList?id=${pmsProjectExpense.project.projectId}">项目费用列表</a></li>
		<li class="active"><a href="">项目费用修改</a></li>
	</ul>
	<form:form id="addForm" modelAttribute="pmsProjectExpense"
		action="${ctx }/pms/projectHelp/expenseFormTo" method="post"
		class="form-horizontal">
		<form:hidden path="expenseId" />
		<div class="control-group">
			<label class="control-label">项目名称:</label>
			<div class="controls">
				<form:hidden path="project.projectId" value="${pmsProjectExpense.project.projectId}" />
				<input type="text" value="${pmsProjectExpense.project.projectName }" htmlEscape="false" maxlength="50" readonly="true"/>
			</div>
		</div>
		<div class="control-group">
