...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/pms/projectHelp/helpList?id=${pmsProject.projectId}">项目求助列表</a></li>
		<li class="active"><a href="">项目求助添加</a></li>
	</ul>
	<form:form id="addForm" modelAttribute="pmsProjectHelp"
		action="${ctx }/pms/projectHelp/helpAdd" method="post"
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="user0" name="helper.id" value="${user.id}" labelName="helper.name" labelValue="${user.office.name}"
