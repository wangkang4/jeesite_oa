...
<script type="text/javascript">
	...
	function yanzhen(bool){
		var reg = /^[1-9][0-9]*$/;
		var numDay = $("#numDay").val().replace(/(^\s+)|(\s+$)/g,"");
			...
			<table class="table-form">
				<tr>
					...
					<td><input id="user.name" name="user.id"
						...
						value="${overTime.user.name }" readonly="readonly">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input id="numDay" name="days" value="<fmt:formatNumber  type='number'   value='${overTime.days } '  maxFractionDigits='1'/>"/>小时
						<span class="tell" style="color:red;"></span>
					</td>
					<td class="tit">部门</td>
					<td>
