...
<body>
	...
	<form:form id="searchForm" modelAttribute="client" action="${ctx}/oa/client/add" method="post" class="form-horizontal">
		<form:hidden path="id" value="${client.id }"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">客户名称：</label>
			<div class="controls">
				<form:input id="clientName" path="clientName" value=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input id="clientCompany" path="clientCompany" value=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">客户负责人名称：</label>
			<div class="controls">
				<form:input path="clientManagerName" value=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">客户负责人性别：</label>
			<div class="controls">
				<form:input path="clientManagerSex" value=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">客户负责人手机：</label>
			<div class="controls">
				<form:input path="clientManagerPhone" value=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">备注：</label>
			<div class="controls">
				<form:input path="content" value=""/>
			</div>
		</div>
