...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/client/project/form">客户添加</a></li>
	</ul><br/>
	<input id="sign" type="hidden" />
	<form:form id="searchForm" modelAttribute="project" action="${ctx}/oa/client/project/add" method="post" class="form-horizontal">
		<form:hidden path="id" value="${project.id }"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">项目名称：</label>
			<div class="controls">
				<form:input id="projectName" path="projectName" value=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="projectManager" name="projectManager.id" value="${projectManager.user.id}" labelName="projectManager.name" labelValue="${projectManager.office.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="projectMoney" value=""/>
			</div>
		</div>
