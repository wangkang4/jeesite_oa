...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/daily/tDaily/form">日报新增</a></li>
	</ul>
	<input id="sign" type="hidden" />
	<form:form id="searchForm" modelAttribute="tDaily"
		action="${ctx}/daily/tDaily/save" method="post"
		class="breadcrumb form-search">
		<input type="hidden" id="id" value="${tDaily.id }" />
		<table id="contentTable"
			class="table table-striped table-bordered table-condensed">
			<thead>
				<tr>
					<th colspan="4"
						style="text-align: center; font-size: 18px; height: 30px;">日报新增</th>
				</tr>
			</thead>
			<tbody>
...
<!-- 						onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" /></td> -->
		...
		<div class="form-actions"  style="float:right;clear:both;margin-right:45%">
			<input id="btn" class="btn btn-primary" type="button" style="margin-right:50px"
				onclick="doSubmit()" value="发送" /> &nbsp; <input id="btnCancel"
